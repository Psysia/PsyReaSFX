...
const PREVIEW_FALLBACK = {
  ...
  url: "https://github.com/Psysia/PsyReaSFX/releases/tag/v0.9.0-beta7"
};
...
const messages = {
  en: {
    ...
    neuralInstallNote: "Enable pre-release versions and install PsyReaSFX.lua Beta 7. On Windows x64, install the matching optional PsyReaSFX Neural Similarity package if needed.",
    ...
    findText: "Beta 7 adds separate AI semantic search with DeepSeek, OpenAI and compatible APIs, alongside optional local EfficientAT similarity search.",
    ...
    installLead: "Import and synchronize the repository, enable package pre-releases, and install PsyReaSFX.lua Beta 7. On Windows x64, repeat for the matching optional PsyReaSFX Neural Similarity package. Both update through the same URL.",
    stepOne: "Open Extensions → ReaPack → Import repositories…",
    stepTwo: "Paste the repository URL below.",
    stepThree: "Enable pre-releases and install PsyReaSFX.lua Beta 7; on Windows x64, repeat for PsyReaSFX Neural Similarity if needed.",
    copy: "Copy",
    copied: "Copied",
    host: "Host",
    required: "Required",
  ...
  zh: {
    ...
    neuralInstallNote: "先启用预发布并安装 PsyReaSFX.lua Beta 7；Windows x64 如需神经检索，再安装配套的可选包 PsyReaSFX Neural Similarity。",
    ...
    findText: "Beta 7 新增独立 AI 语义搜索，支持 DeepSeek、OpenAI 和兼容接口，并保留可选的本地 EfficientAT 相似检索。",
    ...
    installLead: "在 ReaPack 中导入并同步仓库，为软件包启用预发布后安装 PsyReaSFX.lua Beta 7；Windows x64 用户如需神经检索，再安装配套的可选包 PsyReaSFX Neural Similarity。两个包都通过同一地址更新。",
    stepOne: "打开 Extensions → ReaPack → Import repositories…",
    stepTwo: "粘贴下方仓库地址。",
    stepThree: "启用预发布并安装 PsyReaSFX.lua Beta 7；Windows x64 如需神经检索，再对 PsyReaSFX Neural Similarity 执行同样操作。",
    copy: "复制",
    copied: "已复制",
    host: "宿主",
    required: "必需",
