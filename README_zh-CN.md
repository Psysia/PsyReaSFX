...
<p align="center">
  <img src="https://img.shields.io/badge/版本-0.7.15--beta.19-19D8FF" alt="0.7.15 beta 19">
...
`0.7.15 Beta 19` 属于当前 0.7 开发线，重点扩展和验证 Transfer、试听与交付工作流。测试期间，`0.6.21` 仍可作为稳定回退版本。
