...
- **Preview channel: 0.9.0 Beta 7.2** — updates the DeepSeek Flash / V4 Pro models, fixes the AI settings layout, and makes API-key save results clearly visible.
...
- [PsyReaSFX 0.9.0 Beta 7.2 preview](https://github.com/Psysia/PsyReaSFX/releases/tag/v0.9.0-beta7.2)
- [Manual ZIP fallback for the optional Beta 7.2 neural component](https://github.com/Psysia/PsyReaSFX/releases/download/v0.9.0-beta7.2/PsyReaSFX_Neural_Similarity_v0_9_0_beta7_2_win_x64.zip)
