...
| Display | Video Item Track Name Overlay | Show the current track name inside each video Item with adaptive multiline layout; renaming the track updates the overlay automatically. |
