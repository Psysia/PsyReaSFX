...
- Fixes Windows folders dropped onto the main result area being rejected with the “drop a folder” warning.
...
- Completes the former Beta 3, Beta 4 and Beta 5 reliability roadmap in this
  single build instead of splitting it into small incremental previews.
...
- Publishes 0.7.23 Stable and 0.8.0 Beta 2 together in the same ReaPack package.
  Stable remains the default; users can opt into previews with ReaPack's
  per-package pre-release setting and switch from the Versions menu.
