...
**Applies to:** PsyReaSFX 0.8.5 Stable / 0.9.0 Beta 7.4
**Author:** Psysia  
**Host:** REAPER 7.x
...
4. Search for `PsyReaSFX.lua`, right-click it, enable pre-release versions for
   that package, choose `0.9.0-beta7.4` under **Versions**, and install it.
...
### Optional neural similarity component (Beta 7.4)
...
choose `0.9.0-beta7.4`, and install it beside `PsyReaSFX.lua`. ReaPack places
...
Starting with Beta 7.4, AI search uses an independent background-job resource and captures its asset-array snapshot at launch. Long-running waveform precaching, cache verification, catalog snapshots, and other catalog maintenance therefore no longer cause `resource_busy`.
...
With the optional Beta 7.4 component installed, PsyReaSFX uses EfficientAT
...
PsyReaSFX 0.9.0 Beta 7.4 as versions of the same package. Normal synchronization
