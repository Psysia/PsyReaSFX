...
- The displayed text comes from the current REAPER track name; source filenames and extensions are no longer used as the label.
...
- **js_ReaScriptAPI:** required by Video Item Track Name Overlay.
